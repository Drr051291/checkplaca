...
import { createHowToSchema } from "@/components/SEO";
...
export const IncludedSection = () => {
  ...
  const howToSteps = [
    "Digite a placa do veículo no campo de busca na página inicial",
    "Clique em 'Consultar' para ver o resumo gratuito com dados básicos",
    "Para obter o relatório completo com FIPE, histórico e gravames, clique em 'Desbloquear Relatório'",
    "Realize o pagamento via Pix de forma segura",
    "Acesse instantaneamente seu relatório completo e faça o download em PDF"
  ];
  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-primary/5 via-background to-accent/5" aria-labelledby="included-titulo">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <header className="text-center mb-8 sm:mb-12">
              <h2 id="included-titulo" className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 px-4">
            ...
            <ul className="grid sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8" role="list" aria-label="Benefícios inclusos no relatório">
